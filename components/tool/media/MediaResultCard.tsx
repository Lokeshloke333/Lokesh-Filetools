...
import { Download, RefreshCw, CheckCircle2, FileAudio, Settings2 } from "lucide-react";
...
export function MediaResultCard({ result, onDownload, onReset, resetButtonText = "Process Another", options }: MediaResultCardProps) {
  return (
