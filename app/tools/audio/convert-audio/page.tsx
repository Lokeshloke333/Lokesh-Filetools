...
export default function ConvertAudioPage() {
  ...
  return (
    <ToolLayout>
      ...
      <AboutTool 
        title="About our FFmpeg Audio Engine"
        content={
          <>
            <p>
              To provide blazing-fast conversions for files up to 200MB, we use <strong>FFmpeg WebAssembly</strong>. Instead of uploading your massive audio files to a remote server, our tool downloads a lightweight conversion engine directly into your browser.
            </p>
            <p>
              This means your audio files are processed locally using your device's CPU. Not only does this guarantee 100% privacy, but it also allows you to adjust bitrates, sample rates, and channels on-the-fly without waiting for slow internet uploads.
            </p>
          </>
        }
      />
